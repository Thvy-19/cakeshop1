    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalUpdateStatusLabel">Cập nhật đơn hàng</h5>
          ...
          <form action="{{ route('orderUpdateStatus', $order->order_code) }}" method="post">
            ...
            <div class="input-group">
              <select class="form-select" id="inputGroupSelect01" name="status">
                ...
                <option value="3" {{ $order->status == 3 ? 'selected' : '' }}>Đang chờ</option>
                <option value="4" {{ $order->status == 4 ? 'selected' : '' }}>Đang giao</option>
                <option value="5" {{ $order->status == 5 ? 'selected' : '' }}>Hoàn tất</option>
              </select>
