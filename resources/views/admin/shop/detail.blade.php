        ...
        <div class="row">
          ...
          <div id="file-upload-form" class="uploader @error('path') is-invalid @enderror">
            ...
            <label for="file-upload" id="file-drag">
              ...
              <div>Tải ảnh logo cửa hàng</div>
              @error('path')
                <span class="text-danger">{{ $message }}</span><br>
              @enderror
              <div id="notimage" class="hidden">Hãy chọn ảnh            
              </div>
              <span id="file-upload-btn" class="btn btn-primary">Chọn file</span>
              </div><br>
          ...
          <div class="col-md-8 col-12">
            <div class="form-group">
              ...
              <input type="text" name="name_shop" id="name_shop" class="form-control  @error('name_shop') is-invalid @enderror" placeholder="Tên cửa hàng" value="{{ $shop->name_shop }}" required autofocus>
              @error('name_shop') 
            ...
            <div class="form-group">
              ...
              <input type="number" name="phone" id="phone" class="form-control  @error('phone') is-invalid @enderror" placeholder="Số điện thoại" value="{{ $shop->phone }}" required >
              @error('phone') 
                <small class="text-danger">{{ $message }}</small>
              @enderror
            </div>
